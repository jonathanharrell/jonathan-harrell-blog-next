...
export const FilterTags = ({ tags, selectedTag }: FilterTagsProps) => {
      ...
      <div className="sm:hidden">
        ...
        <div>
          <select
            ...
            className="select appearance-none w-full py-2.5 pl-3 pr-8 rounded-full border border-neutral-200 dark:border-neutral-700 hover:border-neutral-400 bg-transparent leading-none transition-colors duration-200 ease-in-out cursor-pointer"
