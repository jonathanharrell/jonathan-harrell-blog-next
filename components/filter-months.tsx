    ...
    <div className="flex flex-col gap-1">
      ...
      <div>
        <select
          ...
          className="select appearance-none w-full sm:w-auto py-2.5 sm:py-1.5 pl-3 pr-8 rounded-full border border-neutral-200 hover:border-neutral-400 bg-transparent sm:leading-none transition-colors duration-200 ease-in-out cursor-pointer"
