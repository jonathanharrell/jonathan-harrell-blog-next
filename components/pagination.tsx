            ...
            {Array.from({ length: totalPages }).map((_, index) => (
              <Link
                ...
                className={classNames(
                  "py-3 px-4 border border-neutral-200 dark:border-neutral-700 hover:border-neutral-400 text-neutral-500 leading-none transition-colors duration-200 ease-in-out",
                  currentPage === index
