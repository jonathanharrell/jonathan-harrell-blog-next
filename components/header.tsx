  ...
  return (
    <header className="group">
      <div className="wrapper">
        <div className="flex flex-col sm:flex-row items-center md:items-baseline justify-between gap-2 md:gap-4 pt-8 pb-6 border-b border-neutral-200 dark:border-neutral-700">
